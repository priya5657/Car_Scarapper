...
// export default function AdminRequestScrapPage() {
...
//   return (
//     <div className="p-6">
//       <h1 className="text-2xl font-bold mb-6">Scrap Requests (Admin)</h1>
...
//                 <FileText size={14} />
//                 Dealer: {req.dealer?.name || "N/A"}
//               </p>

//               <p className="text-sm text-gray-600 mt-2">
//                 Price Quote: ₹{req.price || "N/A"}
//               </p>
